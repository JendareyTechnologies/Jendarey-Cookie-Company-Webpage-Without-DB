...
# docker build . -t jendaredocker/jendarey-cookie-company-webpage
# docker run -d -p 12000:8080 --name=cookie-webpage jendaredocker/jendarey-cookie-company-webpage:latest
...
# docker run -it -p 12000:8080 tomcat:10.1.13-jdk17
# docker compose up
# docker exec -it ac7 bash 
